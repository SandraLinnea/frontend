...
// Lägg hela logiken som använder useSearchParams i en *inre* komponent
function NewBookingInner() {
  ...
  const [msg, setMsg] = useState<string>("");
  const router = useRouter();
  const sp = useSearchParams(); // ← funkar nu, vi är i Suspense
...
// Sidan exporterar en Suspense-boundary runt inner-komponenten
export default function NewBookingPage() {
  return (
